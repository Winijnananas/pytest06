from function import number_to_month,validate_number #เรียกfunction
import pytest

@pytest.mark.code #pytest -m code  #pytest.mark.validate
...
@pytest.mark.validate #pytest -m validate
def test_out_of_range_input_nagativ_1_5():
    input = -1.5
    expected_result = "out of range"
    actual_result = validate_number(input)
    assert expected_result == actual_result
